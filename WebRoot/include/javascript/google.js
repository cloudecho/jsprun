...
document.writeln('		theform.q.value = \'site:' + google_host.replace(":80$","") + ' \' + theform.q.value;');
document.writeln('	}');
document.writeln('}');
...
document.write('<a href="http://www.google.cn/webhp?ie='+google_charset+'&oe=UTF-8&hl='+google_hl+'&lr='+google_lr+'" target="_blank"><div style="cursor:pointer;float: left;width:70px;height:23px;background: url(images/common/Google_small.png) !important;background: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'images/common/Google_small.png\', sizingMethod=\'scale\')"><img src="images/common/none.gif" border="0" alt="Google" /></div></a>');
