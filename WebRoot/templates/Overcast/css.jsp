...
#forumlist_menu { padding: 10px 30px 10px 20px; }
	#forumlist_menu dl { padding: 5px 0; }
		#forumlist_menu dt a { font-weight: bold; color: {TEXT}; }
		#forumlist_menu dd { padding-left: 1em; }
			#forumlist_menu li.sub { padding-left: 1em; }
			#forumlist_menu li.current a { font-weight: bold; }
			#forumlist_menu li a { font-weight: normal; color: {HIGHLIGHTLINK}; }
.userinfopanel { border: 1px solid {CATBORDER}; width: 160px; {PORTALBOXBGCODE}; background-repeat: repeat-x; background-position: 0 0; padding: 10px; }
